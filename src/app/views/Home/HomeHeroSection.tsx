...
import BounceCards from "@/components/ui/BounceCard"
...
export function HomeHeroSection() {
  ...
  const lines = [t("hero.title1"), t("hero.title2"), t("hero.title3")]
    ...
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center   pt-20 lg:px-0 lg:pt-0">
        ...
        <div className="flex w-full max-w-3xl flex-col items-center justify-center">
          {lines.map((line, index) => (
            <motion.span
              ...
              className="sizeTitle text-center font-semibold dark:text-textDarkPrimary"
            >
              {line}
            </motion.span>
          ))}
      ...
      <div className="flex w-full flex-col items-center justify-center border-b border-borderPrimary">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease: "easeInOut" }}
          className="sizeSubtitle flex w-full max-w-3xl items-center justify-center px-5 py-5 text-center text-textSecondary dark:text-textDarkSecondary lg:px-0"
        >
          {t("hero.description")}
        </motion.div>
      </div>
