...
import { Stack } from "@/components/ui/CardStack"
        ...
        <div className="grid w-full auto-rows-[120px] grid-cols-1 grid-rows-5 gap-3 py-6 md:grid-cols-2 lg:auto-rows-[200px] lg:grid-cols-5 ">
          ...
          <GridCard className="col-span-1 row-span-2 flex flex-col gap-4 px-4 py-4 md:col-span-2 lg:px-5 lg:py-6" href="/about">
            <div className="flex flex-col gap-2 ">
              <h1 className="text-lg font-semibold dark:text-textDarkPrimary lg:text-xl">{t("about.card1.title")}</h1>
              <p className="sizeSubtitle text-textSecondary dark:text-textDarkSecondary">{t("about.card1.description")}</p>
            </div>
          ...
          <GridCard className="col-span-1 row-span-3 md:col-span-2 lg:col-span-3" href="/about">
            <div className="flex h-full w-full flex-col justify-center gap-6 overflow-hidden bg-[url('/assets/elements/element-grid.png')] bg-cover bg-center px-4 py-4 lg:gap-8 lg:px-5 lg:py-6">
              <div className="flex flex-col gap-2">
                <h1 className="text-lg font-semibold dark:text-bgDarkPrimary lg:text-xl">{t("about.card2.title")}</h1>
                <p className="sizeSubtitle text-textSecondary dark:text-bgDarkSecondary">{t("about.card2.description")}</p>
              </div>
            </div>
          </GridCard>
          ...
          <GridCard className="col-span-1 row-span-3 md:col-span-2" href="/toolbox">
            <div className="flex h-full flex-col gap-6 overflow-hidden px-4 py-4 lg:gap-8 lg:px-5 lg:py-6">
              <div className="flex flex-col gap-2 text-center">
                <h1 className="text-lg font-semibold dark:text-textDarkPrimary lg:text-xl">{t("about.card3.title")}</h1>
                <p className="sizeSubtitle text-textSecondary dark:text-textDarkSecondary">{t("about.card3.description")}</p>
              </div>
          ...
          <GridCard className="col-span-1 row-span-2 md:col-span-2 lg:col-span-3" href="/about">
            <div className="flex h-full flex-col justify-center gap-6 overflow-hidden px-4 py-4 lg:gap-8 lg:px-5 lg:py-6">
              <div className="flex flex-col gap-2">
                <h1 className="text-lg font-semibold dark:text-textDarkPrimary lg:text-xl">{t("about.card4.title")}</h1>
                <p className="sizeSubtitle text-textSecondary dark:text-textDarkSecondary">{t("about.card4.description")}</p>
              </div>
            </div>
          </GridCard>
        </div>
