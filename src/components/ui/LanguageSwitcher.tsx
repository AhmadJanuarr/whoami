  ...
  return (
    <div ref={wrapperRef} className="fixed bottom-20 right-4 z-20 flex items-end">
      ...
      <button
        ...
        className="group relative flex h-12 w-12 items-center justify-center rounded-full p-2 shadow-lg ring-1 ring-indigo-200 transition-transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-indigo-300"
      >
