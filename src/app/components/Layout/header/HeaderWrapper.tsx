...
export const HeaderWrapper = () => {
  ...
  const NAV_ITEMS = [
    { label: t("home"), onClick: () => router.push("/"), isActive: pathname === "/" },
    { label: t("about"), onClick: () => router.push("/about"), isActive: pathname === "/about" },
    { label: t("blogs"), onClick: () => router.push("/blogs"), isActive: pathname === "/blogs" },
    { label: t("projects"), onClick: () => router.push("/projects"), isActive: pathname === "/projects" },
    { label: t("toolbox"), onClick: () => router.push("/toolbox"), isActive: pathname === "/toolbox" },
  ]
